    ...
    <section className="py-16 bg-[#faf8f5]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-12">
          <h2 className="uppercase tracking-[4px] text-2xl lg:text-2xl font-semibold text-[#222] bg-orange-100 py-2">
            Premium Plotted Development
            <span className="text-[#d97706] mx-4">+</span> /
            <span className="ml-4">Modern Infrastructure</span>
          </h2>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-start">
          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <h2 className="text-4xl font-bold text-[#2d3a22]">
                Interior Collections
              </h2>

              <p className="mt-4 text-gray-600 leading-7 max-w-lg">
                Discover well-planned layouts, lush green spaces, modern amenities, and premium infrastructure.
              </p>
